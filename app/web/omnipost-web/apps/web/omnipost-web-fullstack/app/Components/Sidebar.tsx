...
export function SidebarBody({ onNavigate }: { onNavigate?: () => void }) {
    ...
    return (
        <div className="flex flex-col h-full w-full bg-primary-dark text-white">
            ...
            <div className="shrink-0 border-t border-white/15 px-4 py-4">
                <Link
                    ...
                    onClick={onNavigate}
                    className="flex items-center gap-3 rounded-xl p-2 hover:bg-white/10 transition-colors duration-150 group"
                >
                    {/* Avatar */}
                    {avatarUrl ? (
                        <Image
